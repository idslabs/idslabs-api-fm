<?php
namespace FileManager\Image\Service;
...
use FileManager\Image\Entity\Image as ImageEntity;
use FileManager\Image\Mapper\ImageInterface as ImageMapperInterface;
...
class Image implements ServiceLocatorAwareInterface
{
    ...
    /**
     * @var \FileManager\Image\Entity\User
     */
    protected $user;

    /**
     * @var \FileManager\Image\Entity\ImageEntityInterface
     */
    protected $entity;
    ...
    /**
     * @var \FileManager\Image\Mapper\ImageInterface
     */
    protected $mapper;
    ...
    {
        $mapper   = $this->getServiceLocator()->get('FileManager\\Image\\Mapper\\Image');
    ...
    {
        if ($this->mapper === null) {
            $this->setMapper($this->getServiceLocator()->get('FileManager\\Image\\Mapper\\Image'));
        }
     ...
     * Set Mapper
     *
     * @param FileManager\Image\Mapper\ImageInterface $mapper
     */
