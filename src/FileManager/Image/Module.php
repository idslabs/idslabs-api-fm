...
class Module implements ApigilityProviderInterface
{
    public function onBootstrap(MvcEvent $mvcEvent)
    {
        ...
        $sharedEventManager->attachAggregate($serviceManager->get('FileManager\\Image\\SharedEventListener'));
        ...
        $eventManager->attach(
            ...
            $serviceManager->get('FileManager\\Image\\Authorization\\AclScopeListener'),
            101
        );
        // attach ACL for checking Image Owner
        $eventManager->attach(
            MvcAuthEvent::EVENT_AUTHORIZATION_POST,
            $serviceManager->get('FileManager\\Image\\Authorization\\AclImageListener'),
            100
        );
    }
