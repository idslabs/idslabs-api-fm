...
namespace FileManager\Image\Mapper\Adapter;
...
class DoctrineORMImage implements ImageMapperInterface, ServiceLocatorAwareInterface
{
    ...
    public function getHydrator()
    {
        if ($this->hydrator === null) {
            ...
            $this->setHydrator($hydratorManager->get('FileManager\\Image\\Entity\\Hydrator'));
        }
    ...
    {
        return $this->getEntityManager()->getRepository('FileManager\Image\Entity\Image');
    }
}
